...
const CuisineDetailsDialog = ({ open, onOpenChange, attraction }) => {
          ...
          <div className="custom-scrollbar max-h-[88vh] overflow-y-auto bg-white">
            <div className="relative aspect-[16/8] min-h-[240px] bg-slate-100">
              ...
              <div className="absolute left-4 top-4 flex flex-wrap gap-2">
                <DetailPill>
                  {formatLabel(attraction.attraction_type)}
                </DetailPill>
                {attraction.is_featured && (
                  <DetailPill>
                    <Star
                      size={12}
                      className="mr-1 inline-block fill-current"
                    />
                    Featured
                  </DetailPill>
                )}
...
export default CuisineDetailsDialog;
